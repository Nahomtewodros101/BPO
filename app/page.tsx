...
const InteractiveSVGBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    >
      ...
      >
        <polygon
          points="600,100 620,120 600,140 580,120"
          fill="#10b981"
          opacity="0.4"
        />
      </motion.g>
      ...
      >
        <polygon
          points="900,500 920,520 900,540 880,520"
          fill="#059669"
          opacity="0.3"
        />
      </motion.g>
...
const services = [
  {
    ...
    description:
      "Complete HR solutions including recruitment, payroll, and employee management.",
    features: [
      "Talent Acquisition",
      "Payroll Processing",
  ...
  },
  {
    ...
    title: "IT Support",
    description:
      "24/7 technical support and IT infrastructure management services.",
  ...
  },
  {
    ...
    description:
      "Strategic consulting to help your business reach its full potential.",
...
const testimonials = [
  ...
  },
  {
    ...
    role: "Founder",
    content:
      "Outstanding service quality. Their HR solutions helped us scale from 10 to 100 employees seamlessly.",
    rating: 5,
  },
  {
...
export default function HomePage() {
        ...
        setJobs([
          {
            ...
            posted: "2024-01-12",
            description:
              "Lead process improvement initiatives and optimize business workflows for our clients.",
            requirements: [
          ...
          },
          {
            ...
            posted: "2024-01-10",
            description:
              "Manage client relationships and ensure successful implementation of our BPO solutions.",
            requirements: [
          ...
          },
          {
            ...
            posted: "2024-01-08",
            description:
              "Develop and execute digital marketing strategies for our clients across various industries.",
            requirements: [
          ...
          },
          {
            ...
            posted: "2024-01-05",
            description:
              "Support HR operations and help streamline processes for our growing team.",
            requirements: [
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-x-hidden">
      ...
      >
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <span className="text-2xl font-bold">MJDAT </span>
            </motion.div>
            {/* Desktop Navigation */}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              announcements from MJDAT Solutions.
            </p>
          </motion.div>
          {loading ? (
      ...
      <section
        id="services"
        className="py-20 bg-transparent text-slate-900 dark:text-white relative"
      >
        <GeometricAccent className="left-0 top-20" />
        <div className="container mx-auto px-4">
          <motion.div
          ...
          >
            ...
            <p className="text-xl text-slate-600 dark:text-gray-300 max-w-3xl mx-auto">
              From HR management to digital marketing, we provide end-to-end
              outsourcing solutions tailored to your business needs.
            </p>
          </motion.div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <ul className="space-y-2">
                        {service.features.map((feature, idx) => (
                          <li
                            key={idx}
                            className="flex items-center text-sm text-slate-600 dark:text-gray-300"
                          >
      ...
      <section
        id="about"
        className="py-20 bg-bg-transparent text-slate-900 dark:text-white relative"
      >
        <GeometricAccent className="left-0 top-1/4" />
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 dark:text-gray-300 mb-6 leading-relaxed">
                ...
                and a problem-solving mindset to every challenge.
              </p>
              <p className="text-lg text-slate-600 dark:text-gray-300 mb-6 leading-relaxed">
                Our services are designed to reduce operational burdens, improve
                performance, and ensure compliance, all while allowing our
                partners to focus on their core competencies.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
              Ready to transform your business? Get in touch with us through
              ...
              <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all duration-300 text-center p-8">
                <CardContent className="p-0">
                  ...
                  <p className="text-black mb-6">
                    Join our Telegram channel for instant updates and quick
                    communication.
                  </p>
            ...
            >
              <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all duration-300 text-center p-8">
                <CardContent className="p-0">
                  ...
                  <p className="text-black mb-6">
                    Connect with us professionally on LinkedIn for business
                    networking.
                  </p>
                  <div className="flex items-center justify-center text-black group-hover:text-black transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Transforming businesses through comprehensive outsourcing
                solutions and innovative BPO services.
              </p>
